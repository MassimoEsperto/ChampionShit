...
$response =  file_get_contents('https://www.fantacalcio.it/probabili-formazioni-serie-a/index.html');
$page = explode("player-name", $response);

$arr_length = count($page);

for($i=1;$i<$arr_length;$i++)
{
  	$singolo_tmp = explode("player-percentage-value", $page[$i]);
